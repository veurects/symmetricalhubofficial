...
local SelfModules = {
	UI = loadstring(game:HttpGet("https://raw.githubusercontent.com/veurects/symmetricalhubofficial/main/utilities/UI.lua"))(),
	Directory = loadstring(game:HttpGet("https://raw.githubusercontent.com/veurects/symmetricalhubofficial/main/utilities/Directory.lua"))(),
}
